...
public class DadoPopulacional implements Serializable {
    ...
    public DadoPopulacional(final String ano, final BigDecimal totalPopulacao, final Long totalHomens, final Long totalMulheres) {
        this.ano = ano;
        this.populacaoTotal = totalPopulacao;
